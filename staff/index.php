...
<div class="col-12 col-md-6 p-3 p-md-5 bg-warning text-center"> <img width="360" class="img-fluid" src="../image/bg-2.png" /><br /> Selamat Datang <b><?php echo $_SESSION['username'] ?></b><br /></div>
<div class="col-12 col-md-6 p-3 p-md-5 bg-dark text-white">
    <div class="row">
        <div class="col-md-12 col-12 text-white">
            <div class="card-header text-center text-white"> Peringatan Pesanan</div>
            <div class="card-body">
                <table id="orderTable" class="table text-white" width="100%" cellspacing="0"></table>
            </div>
            <div class="card-footer small text-muted"><i>Refresh Otomatis dalam 3 detik</i></div>
        </div>
    </div>
</div>
